...
job_env = Environment(
    ...
    description="Custom environment for TITANIC pipeline",
...
registered_model_name = "titanic_defaults_model"
job = command(
    inputs=job_input,
    compute=ci_basic_name,
    environment=f"{job_env.name}:{job_env.version}",
    code="./src/",
    command="python train_prel.py --data ${{inputs.data}} --kernel ${{inputs.kernel}}",
    experiment_name="sklearn-titanic",
    display_name="sklearn-classify-titanic",
)
